...
print('Ridge Training Score', f1_score(y_train, y_pred_train))
print('Ridge Testing Score', f1_score(y_test, y_pred_test))
...
clf_l1 =LogisticRegressionCV(C_array,cv=5,penalty='l1',scoring = 'f1',solver = 'liblinear')
